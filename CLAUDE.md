...
Tags: `phase5.5-d-metrics-exporter`, `phase5.5-e-retriever-depends`, `phase5.5-f-audit-rotation`, `phase5-observability`, `phase8`, `phase9`, `phase10` (closure at `2e1d9fa`; T10b-3 + T10d Td.1 + T10d Td.2 incrementals 仍在 phase10 内, 无新 tag), `phase10.1` (T10b-1 do-not-move anchor at `1c44eee`).
