...
Tags: `phase5.5-d-metrics-exporter`, `phase5.5-e-retriever-depends`, `phase5.5-f-audit-rotation`, `phase5-observability`, `phase8`, `phase9`, `phase10`, `phase10.1` (T10b-1 do-not-move anchor at `1c44eee`).
