...
> **阶段 1-5 已完成（2026-04 至 2026-06 全部交付）**。本表保留作为原始 spec。
> **阶段 6-13 已交付**（phase6a/6b/6c/7/8/9/10/10.1/11/11.1/12/12.1/13a/13b/13c/13c-c13），
> 详见顶层 [`CHANGELOG.md`](CHANGELOG.md) 阶段历史。当前状态总结在 [`README.md`](README.md) §"Phase status"。
7. 技术栈明细与接口细化
7.1 总体技术栈
组件	技术选型	版本/备注	用途
